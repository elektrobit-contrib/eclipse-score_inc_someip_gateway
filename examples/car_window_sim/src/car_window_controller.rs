...
pub fn main() -> Result<()> {
    ...
    let offered_skeleton: car_window_types::WindowControlInterface::Skeleton<mw_com::skeleton::Offered> =
        skeleton.offer_service().expect("Failed offering Control Skeleton");
    ...
    loop {
        ...
        match io::stdin().read_line(&mut input) {
            Ok(_) => {
                ...
                let mut wincontrol: car_window_types::WindowControl = car_window_types::WindowControl::default();
