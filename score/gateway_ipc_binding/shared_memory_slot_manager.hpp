...
#define SCORE_GATEWAY_IPC_BINDING_INCLUDE_SCORE_GATEWAY_IPC_BINDING_SHARED_MEMORY_SLOT_MANAGER
...
#endif  // SCORE_GATEWAY_IPC_BINDING_INCLUDE_SCORE_GATEWAY_IPC_BINDING_SHARED_MEMORY_SLOT_MANAGER
